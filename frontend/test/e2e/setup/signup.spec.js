...
describeE2E("setup/signup", { dbKey: "" }, () => {
    describe("onboarding", () => {
        it("should take you to the welcome page", async () => {
            ...
            expect(welcomeText).toEqual('Welcome to Greendeck');
        ...
        it("should allow you to sign up and add db", async () => {
            ...
            await waitForElementAndSendKeys(driver, "[name=email]", 'testy@greendeck.co');
            ...
            expect(await onboardingModalHeading.getText()).toBe('Testy, welcome to Greendeck!');
