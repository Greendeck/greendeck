                ...
                { step === 1 ?
                    <div className="bordered rounded shadowed">
                        <div className="pl4 pr4 pt4 pb1 border-bottom">
                            <h2>{user.first_name}, welcome to Greendeck!</h2>
                            <h2>Analytics you can use by yourself.</h2>

                            <p>Greendeck lets you find answers to your questions from data your company already has.</p>
                ...
                :
                    <div className="bordered rounded shadowed">
                        <div className="pl4 pr4 pt4 pb1 border-bottom">
                            ...
                            <p>We'll take a quick look at the Query Builder, the main tool you'll use in Greendeck to ask questions.</p>
                        </div>
                        <div className="px4 py2 text-grey-2 flex align-center">
                            {this.renderStep()}
