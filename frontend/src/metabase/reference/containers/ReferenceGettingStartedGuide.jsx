                    ...
                    <div className="wrapper wrapper--trim">
                        <div className="mt4 py2">
                            <h1 className="my3 text-dark">
                                Help new Greendeck users find their way around.
                            </h1>
                        ...
                        <GuideEditSection
                            ...
                            link="http://www.greendeck.co/docs/latest/administration-guide/05-segments-and-metrics#creating-a-metric"
                        ...
                        <GuideEditSection
                            ...
                            link="http://www.greendeck.co/docs/latest/administration-guide/05-segments-and-metrics#creating-a-segment"
