    ...
    renderFooter() {
        ...
        return (
            <div className="SetupHelp bordered border-dashed p2 rounded mb4" >
                If you feel stuck, <a className="link" href={"http://www.greendeck.co/docs/"+tag+"/setting-up-metabase"} target="_blank">our getting started guide</a> is just a click away.
            </div>
        );
    }
                ...
                <div className="relative full-height flex flex-full layout-centered">
                    <div className="wrapper wrapper--trim text-centered">
                        ...
                        <div className="relative z2 text-centered ml-auto mr-auto" style={{maxWidth: 550}}>
                            <h1 style={{fontSize: '2.2rem'}} className="text-brand">Welcome to Greendeck</h1>
                            ...
                            { setupComplete ?
                                <section className="SetupStep rounded SetupStep--active flex flex-column layout-centered p4">
                                    ...
                                    <div className="pt4 pb2">
                                        <Link to="/?new" className="Button Button--primary" onClick={this.completeSetup.bind(this)}>Take me to Greendeck</Link>
                                    </div>
                                </section>
                            : null }
